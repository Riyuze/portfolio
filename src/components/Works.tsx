                ...
                <div className="relative w-full h-[230px]">
                    ...
                    <div className="absolute inset-0 flex justify-end m-3">
                        <div
                            ...
                            className="bg-gradient-to-r from-gray-800 via-gray-900 to-black w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
                        >
                            <img
                                src={github}
                                alt="github"
    ...
    return (
        <>
            <motion.div variants={textVariant(0.3)}>
                <p className={styles.sectionSubText}>Works I've done</p>
            ...
            >
                ...
                described with links to code repositories. It reflects my
